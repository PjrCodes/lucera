            ...
            <div className="bg-white rounded-xl shadow p-6 mb-6">
              ...
              <div className="space-y-3">
                ...
                <div className="mt-4 p-3 bg-red-50 border-l-4 border-red-400 rounded">
                  ...
                  Students below threshold will be highlighted here in future
                  updates.
                </div>
              </div>
            </div>
              ...
              <div className="space-y-3">
                <div className="text-gray-700 text-sm">
                  ...
                  <ul className="list-disc list-inside mt-2 text-gray-600 text-xs">
                    ...
                    <li>
                      Click a course to view detailed breakdown and upcoming
                      deadlines.
                    </li>
                  </ul>
                </div>
                <div className="mt-4 p-3 bg-blue-50 border-l-4 border-blue-400 rounded">
                  <span className="font-semibold text-blue-700">Tip:</span> Stay
                  consistent to unlock badges and rewards!
                </div>
              </div>
            </div>
          )}
