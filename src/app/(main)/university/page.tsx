    ...
    <>
      ...
      <main className="max-w-4xl mx-auto py-8 px-2 sm:py-12 sm:px-4 flex flex-col items-center">
        ...
        <p className="text-base sm:text-lg text-primary-700 mb-6 text-center max-w-2xl">
          Welcome to Sample University, a place where innovation meets
          tradition. Our vibrant campus is home to a diverse community of
          learners and educators, dedicated to academic excellence and personal
          growth.
        </p>
        ...
        <p className="text-sm sm:text-md text-primary-700 text-center max-w-2xl">
          ...
          success in a rapidly changing world. Join us and become part of a
          legacy of achievement and discovery.
        </p>
      </main>
    </>
  );
