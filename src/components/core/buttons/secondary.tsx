...
export function SecondaryButton({
  ...
  const variantClasses =
    variant === "outline"
      ...
      : "border-2 border-secondary-500 bg-secondary-600 text-white cursor-pointer hover:bg-secondary-500 transition focus-visible:ring-2 focus-visible:ring-secondary-300 focus-visible:ring-offset-2";
