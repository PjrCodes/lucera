...
export function PrimaryButton({
  ...
  const variantClasses =
    variant === "outline"
      ? "border-2 border-primary-700 text-primary-700 bg-transparent cursor-pointer hover:bg-primary-400 hover:border-primary-800 hover:text-white transition-transform focus-visible:ring-2 focus-visible:ring-primary-800 focus-visible:ring-offset-2 hover:shadow-lg"
