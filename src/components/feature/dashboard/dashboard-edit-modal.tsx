    ...
    return (
      <Dialog open={isOpen} onOpenChange={onClose}>
        <DialogContent className="max-w-4xl border-2 border-primary-400 bg-primary-100">
          <DialogHeader>
            <DialogTitle className="text-primary-700">Loading Dashboard Layout</DialogTitle>
          </DialogHeader>
          <div className="flex items-center justify-center p-8">
            <span className="inline-block w-10 h-10 border-4 border-primary-400 border-t-transparent rounded-full animate-spin" aria-label="Loading" />
          </div>
        </DialogContent>
      </Dialog>
    );
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-6xl max-h-[90vh] flex flex-col border-2 border-primary-400 bg-primary-100">
        <DialogHeader className="rounded-t-lg">
          <DialogTitle className="text-primary-700">Customise your Dashboard</DialogTitle>
        </DialogHeader>
        ...
        <DialogFooter className="mt-auto pt-6">
          <div className="flex items-center gap-2 w-full justify-between">
            ...
            <div className="flex gap-2">
              <SecondaryButton variant="outline" onClick={onClose} disabled={saving}>
                Cancel
              </SecondaryButton>
